...
class TechnicalIndicators:
    ...
    def add_rsi(df: pd.DataFrame, period: int = 14, 
        ...
        df[f'rsi{period}'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df[f'rsi{period}'].fillna(50, inplace=True)  # Fill NaN with neutral value
    ...
    def add_bollinger_bands(df: pd.DataFrame, period: int = 20,
        ...
        df['bb_pctb'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df['bb_width'].fillna(0, inplace=True)
        df['bb_pctb'].fillna(0.5, inplace=True)  # Fill NaN with middle value
    ...
    def add_stochastic(df: pd.DataFrame, k_period: int = 14,
        ...
        # Handle divide by zero
        df['stoch_k'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df['stoch_k'].fillna(50, inplace=True)  # Fill NaN with neutral value
    ...
    def add_cci(df: pd.DataFrame, period: int = 20) -> pd.DataFrame:
        ...
        # Handle divide by zero
        df[f'cci{period}'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df[f'cci{period}'].fillna(0, inplace=True)  # Fill NaN with neutral value
    ...
    def add_adx(df: pd.DataFrame, period: int = 14) -> pd.DataFrame:
        ...
        # Handle divide by zero
        df['dx'].replace([np.inf, -np.inf], np.nan, inplace=True)
    ...
    def add_roc(df: pd.DataFrame, period: int = 12, column: str = 'close') -> pd.DataFrame:
        ...
        # Handle divide by zero
        df[f'roc{period}'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df[f'roc{period}'].fillna(0, inplace=True)  # Fill NaN with neutral value
    ...
    def add_vwap(df: pd.DataFrame) -> pd.DataFrame:
        ...
        df['vwap'].fillna(df['close'], inplace=True)  # Fill NaN with close price
        
        # Drop temporary columns
        df.drop(['tp', 'cumulative_tp_vol', 'cumulative_vol'], axis=1, inplace=True)
...
class FeatureGenerator:
    ...
    def generate_price_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Handle divide by zero
        df['normalized_price'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df['normalized_price'].fillna(0.5, inplace=True)
        ...
        # Handle divide by zero
        df['body_to_range'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df['body_to_range'].fillna(0, inplace=True)
    ...
    def generate_volume_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # Handle divide by zero
        df['volume_ratio_5'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df['volume_ratio_20'].replace([np.inf, -np.inf], np.nan, inplace=True)
        df['volume_ratio_5'].fillna(1, inplace=True)
        df['volume_ratio_20'].fillna(1, inplace=True)
